...
Public Class frmSanPham
    ...
    Dim chuoiketnoi As String = "workstation id=khai-123.mssql.somee.com;packet size=4096;user id=khai123_SQLLogin_8;pwd=bmedgxxn2x;data source=khai-123.mssql.somee.com;persist security info=False;initial catalog=khai-123"
    ...
    Private Sub btnLuu_Click(sender As Object, e As EventArgs) Handles btnLuu.Click
        ...
        Else
            ...
            save.Parameters.AddWithValue("@THANHTIEN", SL)
